...
class Piano:
    def __init__(self):
        ...
        self.dmin7 = [("D", 50), ("F", 70), ("A", 30), ("C", 60)]
        self.g9 = [("G", 50), ("B", 70), ("D", 30), ("F", 60), ("A", 60)]
        self.cM7 = [("C", 50), ("E", 70), ("G", 30), ("B", 60)]


        # todo - matrix with jazz chords and whole note on as dictionaries and weightings
...
#
# (key_graphic, kgrect) = load_img("media/keys.png")
